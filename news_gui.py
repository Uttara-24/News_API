...
class NewsApp:
    def __init__(self):
        #fetch data
        self.data = requests.get('https://newsapi.org/v2/top-headlines?country=us&apiKey=acedd06b8292459792b85461cf6c2717').json()
        #load initial GUI
        self.load_gui()
